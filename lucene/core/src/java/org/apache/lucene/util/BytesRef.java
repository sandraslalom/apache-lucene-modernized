...
public final class BytesRef implements Comparable<BytesRef>, Cloneable {
  ...
  public boolean equals(Object other) {
    return switch (other) {
      case null -> false;
      case BytesRef bytesRef -> this.bytesEquals(bytesRef);
      default -> false;
    };
  }
  ...
  public String toString() {
    var sb = new StringBuilder(2 + 3 * length);
    sb.append('[');
  ...
  /**
   * Creates a new BytesRef from a string using UTF-8 encoding.
   * 
   * @param text the string to convert
   * @return a new BytesRef containing the UTF-8 bytes
   */
  public static BytesRef of(String text) {
    return new BytesRef(text);
  }

  /**
   * Creates a new BytesRef from a byte array.
   * 
   * @param bytes the byte array
   * @return a new BytesRef wrapping the byte array
   */
  ...
  /**
   * Creates a new BytesRef from a byte array slice.
   * 
   * @param bytes the byte array
   * @param offset the starting offset
   * @param length the length
   * @return a new BytesRef wrapping the byte array slice
   */
  ...
  /**
   * Returns true if this BytesRef is empty (length is 0).
   * 
  ...
  /**
   * Returns the byte at the specified index relative to the offset.
   * 
   * @param index the index (relative to offset)
  ...
  /**
   * Returns a copy of the bytes as a new byte array.
   * 
